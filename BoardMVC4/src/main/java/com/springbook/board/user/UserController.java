...
import com.springbook.board.common.CheckInterceptor;
...
public class UserController {
	...
	public Map<String, Object> phAuth(@RequestParam String ph, HttpSession hs) {
		...
		map.put("result", 1);
		// "{\"result\":1}" @ResponseBody를 하면 JSON으로 리턴해줌
	...
	public String profile(@RequestParam(value="uploadProfile",required = true) MultipartFile file, HttpSession hs) {
